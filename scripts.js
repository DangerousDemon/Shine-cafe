...
const menuItems = [
    ...
    { name: 'Chocolate Ice Cream', category: 'ice-cream', price: 10, image: 'ice_cream_chocolate.jpg', description: 'Rich and decadent chocolate ice cream.' },
    { name: 'Strawberry Ice Cream', category: 'ice-cream', price: 10, image: 'ice_cream_strawberry.jpg', description: 'Sweet and refreshing strawberry ice cream.' },
    { name: 'Vanilla Ice Cream', category: 'ice-cream', price: 10, image: 'ice_cream_vanilla.jpg', description: 'Classic and creamy vanilla ice cream.' },
    { name: 'Pistachio Ice Cream', category: 'ice-cream', price: 12, image: 'ice_cream_pistachio.jpg', description: 'A nutty and flavorful ice cream.' },
    { name: 'Bavarian Chocolate Ice Cream', category: 'ice-cream', price: 17, image: 'ice_cream_bavarian_chocolate.jpg', description: 'A rich and decadent chocolate ice cream with a Bavarian twist.' },
    { name: 'Three Cheers Chocolate Ice Cream', category: 'ice-cream', price: 17, image: 'ice_cream_three_cheers_chocolate.jpg', description: 'A triple chocolate indulgence.' },
    { name: 'Cotton Candy Ice Cream', category: 'ice-cream', price: 17, image: 'ice_cream_cotton_candy.jpg', description: 'A sweet and fluffy ice cream.' },
    { name: 'Mango Ice Cream', category: 'ice-cream', price: 10, image: 'ice_cream_mango.jpg', description: 'A refreshing and tropical ice cream.' },
    { name: 'Fruit & Nuts Ice Cream', category: 'ice-cream', price: 12, image: 'ice_cream_fruit_nuts.jpg', description: 'A delicious combination of fruits and nuts.' },
